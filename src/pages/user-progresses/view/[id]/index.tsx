...
import { getUserProgressById } from 'apiSdk/user-progresses';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            User Progress Detail View
          </Text>
          {hasAccess('user_progress', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/user-progresses/edit/${data?.id}`} passHref legacyBehavior>
              <Button
